...
| O17 | Security/RFC hardening roadmap? | P0 done 3.2.0 (branch+remote correlation, CRLF sanitize, Content-Length, TCP cap); P1 timers/retransmission, CANCEL, rport; P2 PRACK, Digest SHA-256 | P1/P2 still open. |
