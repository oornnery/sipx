...
| O13 | T21 remaining completion order? | CANCEL runtime first, REGISTER over UDP first, transaction retransmission timers first, or lab hooks first | Before marking T21 complete. |
