...
- `python -m pytest`: pass, 129 passed, 3 skipped after `1.7.1` BYE Digest retry fix.
...
- `uv build --out-dir /tmp/opencode/sipx-build-1.7.1-final`: pass, built sdist and wheel outside the repo.
