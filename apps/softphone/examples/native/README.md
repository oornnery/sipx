...
uv run --package sipx-cli sipx call sip:<target>@demo.mizu-voip.com:37075 --profile mizu_demo --config apps/softphone/examples/mizu/harness.toml --local-host <your-local-ip> --dtmf '123#' --duration 3 --debug-sip
```
