...
from sipx.core.verdict import ExpectationResult
...
class ExpectationTarget:
    ...
    def capability(self, capability: BackendCapability | str) -> PendingExpectation:
    ...
    def to_support(self, capability: BackendCapability | str) -> PendingExpectation:
