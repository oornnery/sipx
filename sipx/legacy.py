...
#
# Consolidated legacy API: SipUserAgent, SipUac, SipUas, and related types.
# New code should prefer sipx.client.AsyncClient.
        ...
        try:
            while True:
                event = await self._receive_matching(
                    ...
                    predicate=lambda item, cseq=cseq: _response_matches(
                        item,
                        call_id=call_id,
                        cseq_method="INVITE",
                        cseq=cseq,
...
# ---------------------------------------------------------------------------
# SipUac: SIP user-agent client role
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# SipUas: SIP user-agent server role
# ---------------------------------------------------------------------------
