...
class AsyncSIPServer(SIPServerBase):
    ...
    async def _handle_datagram(
        ...
        try:
            ...
            logger.debug("Failed to parse datagram: %s", e)
            return
        ...
        self._log_request(message, source)
        ...
        txn = self._create_server_transaction(message, "UDP")
        ...
        response = await self._resolve_response_async(message, source)
